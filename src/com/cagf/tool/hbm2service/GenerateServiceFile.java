 ...
 * 生成Dao文件
 */
public class GenerateServiceFile {
    ...
    public void generate(String outputDir, String templateFile, List<String> hbmNameList) throws IOException {
        ...
        for (int i = 0; i < hbmNameList.size(); i++) {
            ...
            //将内存中的Dao输出到目录中
            FileWriter out = new FileWriter(new File(outputDir, classPackagePath + "/" + className + "Service.java"));
            out.write(newDao);
            out.close();
        }
    ...
    private String getDaoImplPackageName(String fullClassName) {
        ...
        return fullClassName.substring(0, finishDotPos) + ".service";
    }
